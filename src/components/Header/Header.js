        ...
        <div classNAme={HeaderStyles.headerContainer}>
            ...
            {isLoggedIn ? (
                <div className={HeaderStyles.firstHeaderBtnContainer}>
                    <Button className={Buttonstyles.headerBtn} onClick={handleLoginClick} >로그아웃</Button>
                </div>
            ) : (
                <div className={HeaderStyles.firstHeaderBtnContainer}>
                    <Button className={Buttonstyles.headerBtn} onClick={handleLoginClick} >로그인</Button>
                    <Button className={Buttonstyles.headerBtn} onClick={handleSignupClick} >회원가입</Button>
                </div>
            )}
            </div>
